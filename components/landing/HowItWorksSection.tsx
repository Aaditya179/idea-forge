...
export default function HowItWorksSection() {
  return (
    <section
      id="how-it-works"
      className="bg-white text-[#1c1917] py-28 lg:py-36 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#fbefe3] text-[#c86d28] border border-[#f6ddc4] text-xs font-semibold uppercase tracking-widest mb-4">
        ...
        <div className="relative mt-12">
          ...
          <div className="hidden lg:block absolute top-10 left-[10%] right-[10%] h-[2px] bg-[#e6dfd3] z-0">
            {/* Active flow highlight segment */}
            <div className="absolute top-0 left-0 h-full w-2/3 bg-gradient-to-r from-[#c86d28] via-[#1c1917] to-[#e6dfd3]" />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between w-full mb-6">
                    <div className="w-20 h-20 rounded-full bg-[#faf6f0] border-2 border-[#1c1917] group-hover:border-[#c86d28] flex items-center justify-center text-[#1c1917] transition-colors shadow-sm relative">
                      <IconComponent className="w-8 h-8 stroke-[1.75] text-[#1c1917] group-hover:text-[#c86d28] transition-colors" />
                      <span className="absolute -top-2 -right-1 px-2 py-0.5 bg-[#1c1917] text-white font-mono text-xs font-bold rounded-full shadow">
                        {step.num}
                      </span>
                    </div>
                    ...
                    {idx < steps.length - 1 && (
                      <div className="hidden md:flex lg:hidden items-center text-[#d1c7b7] pr-4">
                  ...
                  <div className="space-y-2.5 pr-2">
                    ...
                    <p className="text-sm sm:text-base text-[#4a423a] leading-relaxed font-normal">
                      {step.desc}
                    </p>
                  </div>
                  ...
                  {idx < steps.length - 1 && (
                    <div className="lg:hidden w-0.5 h-12 bg-[#e6dfd3] ml-10 my-4 md:hidden" />
                  )}
                </motion.div>
              );
            })}
